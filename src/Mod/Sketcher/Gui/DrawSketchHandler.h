...
protected:
    ...
    bool isEndPointTangentAutoConstraint(int GeoId,
                                         const Base::Vector2d& Pos,
                                         const Base::Vector2d& Dir) const;

    bool seekAlignmentAutoConstraint(std::vector<AutoConstraint>& constraints,
                                     const Base::Vector2d& Pos,
                                     const Base::Vector2d& Dir);

    bool seekTangentAutoConstraint(std::vector<AutoConstraint>& constraints,
                                   const Base::Vector2d& Pos,
                                   const Base::Vector2d& Dir);
