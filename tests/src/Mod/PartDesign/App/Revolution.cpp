...
// A two-sided groove with either side set to "Through all". One full 360 degree cut
// makes the other side irrelevant, regardless of its mode or direction.
TEST_F(RevolutionTest, GrooveTwoSidesThroughAll)
{
    ...
    groove->Type2.setValue("UpToFace");
    ...
    // The same rule applies when Through all is selected on side 2.
    groove->Type.setValue("UpToFace");
