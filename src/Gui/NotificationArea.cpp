    ...
    : QPushButton(parent)
{
    ...
    if (!pImp->buttonTogglesConsoleViews) {
        ...
        connect(this, &QPushButton::clicked, [this]() {
            auto* reportView = Gui::getMainWindow()->findChild<QDockWidget*>(QLatin1String("Report view"));
            auto* pythonConsole = Gui::getMainWindow()->findChild<QDockWidget*>(QLatin1String("Python console"));
