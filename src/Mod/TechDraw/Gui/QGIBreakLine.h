...
public:
    ...
    void setBreakObject(App::DocumentObject* object) { m_breakObject = object; }
    App::DocumentObject* getBreakObject() const { return m_breakObject.getObject(); }
...
private:
    ...
    App::DocumentObjectT m_breakObject;
