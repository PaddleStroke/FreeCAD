...
${LangFileString} TEXT_WELCOME "Este asistente vai-no guiar na instalación do AstoCAD no seu computador.$\r$\n\
				$\r$\n\
				$_CLICK"
...
#${LangFileString} SecAllUsersDescription "Instalar o AstoCAD monousuário ou multiusuário."
${LangFileString} SecFileAssocDescription "Asociar a extensión .FCStd co AstoCAD."
${LangFileString} SecDesktopDescription "Cria un icone do AstoCAD no ambiente de traballo."
...
#${LangFileString} ConfigInfo "A configuración seguinte do AstoCAD irá demorar un pouco."
...
${LangFileString} AlreadyInstalled "O AstoCAD ${APP_SERIES_KEY2} xa está instalado!$\r$\n\
...
#${LangFileString} FinishPageMessage "Parabéns! O AstoCAD foi instalado con suceso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do AstoCAD pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lanzar o AstoCAD"

${LangFileString} UnNotInRegistryLabel "Non se da achado o AstoCAD no registo.$\r$\n\
					Non se eliminarán os atallos para o ambiente de traballo e no menu de Início."
${LangFileString} UnInstallRunning "Debe fechar o AstoCAD en primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de priviléxios de administrador para desinstalar o AstoCAD!"
${LangFileString} UnReallyRemoveLabel "Seguro que quer eliminar completamente o AstoCAD e todos os seus componentes?"
${LangFileString} UnAstoCADPreferencesTitle 'Preferéncias de usuário do AstoCAD'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Elimina as pastas de configuración do  AstoCAD$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala AstoCAD e todos os seus componentes."
